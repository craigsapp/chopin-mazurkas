## chopin-mazurkas Makefile
##
## Programmer:    Craig Stuart Sapp <craig@ccrma.stanford.edu>
## Creation Date: Tue Jun  3 17:51:20 PDT 2014
## Last Modified: Tue Jun  3 17:51:22 PDT 2014
## Filename:      Makefile
## Syntax:        GNU/BSD makefile
##
## Description:   Makefile for basic processing Humdrum data files 
##                for the mazurkas of Frédéric Chopin.
##
...
#           git clone https://github.com/craigsapp/chopin-mazurkas
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://chopin/mazurkas)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=chopin/mazurkas&file=$$TBASE.krn&format=pdf" \
...
#    tindex kern/mazurka07-5.krn | themax -I "+P4 +P4" --loc | theloc --mark | myank --marks
#
#
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/craigsapp/chopin-mazurkas[0;31m"
	@echo "[0m"
	exit 1
endif
